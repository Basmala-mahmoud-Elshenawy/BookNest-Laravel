...
<div class="section-head" style="margin-top:40px;"><h2>Recommended For You</h2><a href="{{ route('recommendations.index') }}" class="view-all">See all <span class="link-chevron" aria-hidden="true">›</span></a></div>
