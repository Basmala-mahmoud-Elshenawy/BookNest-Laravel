<?php $__env->startSection('title', 'BookNest AI Assistant'); ?>
    ...
    <div class="container chat-wrap">
        ...
        <div class="card" style="margin-top:20px;">
            <div class="chat-window" id="chat-window">
                <div class="chat-bubble bot">Hi <?php echo e(auth()->user()->name); ?>! How can I help you find your next book today?</div>
            </div>
...
form.addEventListener('submit', async (e) => {
    ...
    try {
        const res = await fetch('<?php echo e(route('chatbot.send')); ?>', {
            method: 'POST',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\BASMALA\OneDrive\Desktop\BookNest-Final-RuleBased-AI\booknest\resources\views/chatbot/index.blade.php ENDPATH**/ ?>